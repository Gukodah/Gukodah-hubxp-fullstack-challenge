...
import { Eye, EyeOff, User, Mail, Lock, ArrowRight, Zap, Brain } from 'lucide-react'
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Label } from "@/components/ui/label"
import Link from "next/link"
import { usePostV1TokenMutation } from "@/store/api/users.api"
...
export default function LoginPage() {
  ...
  const [login, { isLoading: isLoadingLogin, isSuccess: isSuccessLogin, data: dataLogin }] = usePostV1TokenMutation();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Join your Tasks App account</p>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-400">
                Not have an account?{' '}
                <Link href="/register" className="text-cyan-400 hover:text-cyan-300 underline font-medium">
                  Create a Tasks App Account
                </Link>
              </p>
            </div>
          </CardContent>
